<head>
    <title>ค้นหา/แสดงโต๊ะ | Food Order System</title>
    <?php
...
<body>
    ...
    <div class="container" style="padding-top: 135px;">
        <h1 class="page-header text-left">ค้นหา/แสดงโต๊ะ</h1>
        ...
        if ($num_rows > 0) { // ค้นหพบรายการอาหาร ให้แสดง
            while ($result = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
                ...
                <tr>
                    ...
                    <td align="center"><a href="staff_add_list_tables.php?tables_no=<?= $result['tables_no'] ?>" class="btn btn-success btn-md"><span class="glyphicon glyphicon-shopping-cart"></span> จองโต๊ะ</a></td>
                </tr>
        <?php }
        } else {
            echo '
...
if (isset($_SESSION['food_admin']['reserve']['tables_no'])) {
    $cartcount = count($_SESSION['food_admin']['reserve']['tables_no']);
} else {
    $cartcount = 0;
}
?>
<div class="sticky-div">
    ...
    <a href="staff_cart_reserve.php" class="sticky-cart btn btn-success"><i style="padding-top:10px; font-size:35px;" class="fa fa-shopping-basket"></i></a>
</div>