        ...
        <form method="POST" id="basket" action="">
			...
			<td colspan="8" class="text-center">ไม่มีสินค้าในตะกร้า</td>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td align="center" style="padding:25px; width:10px"><a href="staff_del_list_food.php?foodid=<?php echo $value['foodid']; ?>"> <span class="glyphicon glyphicon-trash fa-2x" style="color:red;" aria-hidden="true"></span></td>
                                </tr>
                            <?php } ?>
                            <tr>
            ...
            <div class="col-md-offset-3 col-md-6" style="text-align: center;">
                ...
                <a class="btn btn-success <?php
                                            if (!isset($_SESSION['food_admin']['list']['foodid'])) {
                                                echo "disabled";
                                            } ?>" href="select_customer.php?ref=order" role="button">สั่งอาหาร</a>
                ...
                <a class="btn btn-danger <?php
                                            if (!isset($_SESSION['food_admin']['list']['foodid'])) {
                                                echo "disabled";
                                            } ?>" href="staff_del_list_food_all.php" onclick="if(confirm('ต้องการล้างตะกร้าใช่หรือไม่?')) return true; else return false;">ล้างตะกร้า</a>
            </div>
    </div>
    </form><br>
    <?php
